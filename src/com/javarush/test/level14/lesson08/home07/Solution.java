...
public class Solution
{
    ...
    {
        for (Apartament suckIt: apartaments){
            if (suckIt instanceof Apt1Room){
                ((Apt1Room) suckIt).clean1Room();
            }
            if (suckIt instanceof  Apt2Room){
                ((Apt2Room) suckIt).clean2Rooms();
            }
            if (suckIt instanceof Apt3Room){
                ((Apt3Room) suckIt).clean3Rooms();
            }
        }
